    ...
    def test_power_flow_input_power_equals_output_power(self):
        ...
        for path in pathlist:
            ...
            with self.subTest(f"Test esdl file {path_in_str}"):
                ...
                total_active_power, total_reactive_power, active_power_losses, reactive_power_losses = self.get_total_active_and_reactive_power(service, "Transformer.highvoltagetrafo")
    ...
    def test_init_builds_dss_file_correctly(self):
        ...
        for path in pathlist:
            ...
            with self.subTest(f"Test esdl file {path_in_str}"):
                ...
                if path_in_str in self.mv_file_names:
                    amount_of_electricity_cables -= 1
